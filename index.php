...
<html>
<head>
	<title>Create Registration form with MySQL and PHP using Bootstrap</title>
		...
		<div class='row'>
			...
			<div class='col-md-6' >
				...
				<form method='post' action=''>
					...
					<div class="form-group">
					   <label class="pwd">Create a New Password:</label>
					...
					<div class="form-group">
					<label for="mobile">Mobile Number: <input type="mobile" name="mobile" required /></label>
					<br>
					<br>
